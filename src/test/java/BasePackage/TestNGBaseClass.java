...
import Utilities.TestNGExcelUtility;
...
public class TestNGBaseClass {
	...
	public static TestNGExcelUtility eu;
	public static int rowNum;
	public static Properties prop;
	
	@BeforeTest
	@Parameters({"browser"})
	public static WebDriver driverSetup(String browser) throws IOException {
		prop = new Properties();
